package com.leclowndu93150.immersive_effects.particles;
...
public class EnderPearlTrailParticle extends ParticleType<WorldParticleOptions> {

    public EnderPearlTrailParticle() {
